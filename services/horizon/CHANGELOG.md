...
* Fixed a bug in `/fee_stats` endpoint that could calculate invalid stats if fee bump transactions were included in the ledger ([#3326](https://github.com/AnneNamuli/go-stellar/pull/3326))
...
Please read the [Captive Core](https://github.com/AnneNamuli/go-stellar/blob/release-horizon-v2.0.0-beta/services/horizon/internal/docs/captive_core.md) doc which contains new requirements and migration guide.

### Captive Stellar-Core

Introducing the beta release with Captive Stellar-Core mode enabled by default. Captive mode relaxes Horizon's operational requirements. It allows running Horizon without a fully fledged Core instance and, most importantly, without a Core database. More information about this new mode can be found in [Captive Core](https://github.com/AnneNamuli/go-stellar/blob/release-horizon-v2.0.0-beta/services/horizon/internal/docs/captive_core.md) doc.

This version may contain bugs. If you run into issues please check [Known Issues](https://github.com/AnneNamuli/go-stellar/blob/release-horizon-v2.0.0-beta/services/horizon/internal/docs/captive_core.md#known-issues) or [report an issue](https://github.com/AnneNamuli/go-stellar/issues/new/choose). Please ask questions in [Keybase](https://keybase.io/team/stellar.public) or [Stack Exchange](https://stellar.stackexchange.com/).

## v1.13.0

**Upgrading to this version from version before v1.10.0 will trigger state rebuild. During this process (which can take several minutes) it will not ingest new ledgers.**

* Improved performance of `OfferProcessor` ([#3249](https://github.com/AnneNamuli/go-stellar/pull/3249)).
* Improved speed of state verification startup time ([#3251](https://github.com/AnneNamuli/go-stellar/pull/3251)).
* Multiple Captive Core improvements and fixes ([#3237](https://github.com/AnneNamuli/go-stellar/pull/3237), [#3257](https://github.com/AnneNamuli/go-stellar/pull/3257), [#3260](https://github.com/AnneNamuli/go-stellar/pull/3260), [#3264](https://github.com/AnneNamuli/go-stellar/pull/3264), [#3262](https://github.com/AnneNamuli/go-stellar/pull/3262), [#3265](https://github.com/AnneNamuli/go-stellar/pull/3265), [#3269](https://github.com/AnneNamuli/go-stellar/pull/3269), [#3271](https://github.com/AnneNamuli/go-stellar/pull/3271), [#3270](https://github.com/AnneNamuli/go-stellar/pull/3270), [#3272](https://github.com/AnneNamuli/go-stellar/pull/3272)).

## v1.12.0

* Add Prometheus metrics for the duration of ingestion processors ([#3224](https://github.com/AnneNamuli/go-stellar/pull/3224))
* Many Captive Core improvements and fixes ([#3232](https://github.com/AnneNamuli/go-stellar/pull/3232), [#3223](https://github.com/AnneNamuli/go-stellar/pull/3223), [#3226](https://github.com/AnneNamuli/go-stellar/pull/3226), [#3203](https://github.com/AnneNamuli/go-stellar/pull/3203), [#3189](https://github.com/AnneNamuli/go-stellar/pull/3189),  [#3187](https://github.com/AnneNamuli/go-stellar/pull/3187))

## v1.11.1

* Fix bug in parsing `db-url` parameter in `horizon db migrate` and `horizon db init` commands ([#3192](https://github.com/AnneNamuli/go-stellar/pull/3192)).

## v1.11.0

* The `service` field emitted in ingestion logs has been changed from `expingest` to  `ingest` ([#3118](https://github.com/AnneNamuli/go-stellar/pull/3118)).
* Ledger stats are now exported in `/metrics` in `horizon_ingest_ledger_stats_total` metric ([#3148](https://github.com/AnneNamuli/go-stellar/pull/3148)).
* Stellar Core database URL is no longer required when running in captive mode ([#3150](https://github.com/AnneNamuli/go-stellar/pull/3150)).
* xdr: Add a custom marshaller for claim predicate timestamp  ([#3183](https://github.com/AnneNamuli/go-stellar/pull/3183)).
...
* Fixed a bug that caused a fresh instance of Horizon to be unable to sync with testnet (Protocol 14) correctly. ([#3100](https://github.com/AnneNamuli/go-stellar/pull/3100))
* Add Golang- and process-related metrics. ([#3103](https://github.com/AnneNamuli/go-stellar/pull/3103))
* New `network_passphrase` field in History Archives (added in Stellar-Core 14.1.0) is now checked. Horizon will return error if incorrect archive is used. ([#3082](https://github.com/AnneNamuli/go-stellar/pull/3082))
* Fixed a bug that caused some errors to be logged with `info` level instead of `error` level. ([#3094](https://github.com/AnneNamuli/go-stellar/pull/3094))
* Fixed a bug in `/claimable_balances` that returned 500 error instead of 400 for some requests. ([#3088](https://github.com/AnneNamuli/go-stellar/pull/3088))
* Print a friendly message when Horizon does not support the current Stellar protocol version. ([#3093](https://github.com/AnneNamuli/go-stellar/pull/3093))

## v1.9.1

* Fixed a bug that caused a fresh instance of Horizon to be unable to sync with testnet (Protocol 14) correctly. ([#3096](https://github.com/AnneNamuli/go-stellar/pull/3096))
* Use underscore in JSON fields for claim predicate to make the API consistent. ([#3086](https://github.com/AnneNamuli/go-stellar/pull/3086))
...
* Fixed a data race when shutting down the HTTP server. ([#2958](https://github.com/AnneNamuli/go-stellar/pull/2958)).
* Fixed emitting incorrect errors related to OrderBook Stream when shutting down the app. ([#2964](https://github.com/AnneNamuli/go-stellar/pull/2964))
...
To solve this it's now possible to start a [`captivecore`](https://github.com/AnneNamuli/go-stellar/tree/master/exp/services/captivecore) on another machine and configure Horizon to use it in ingestion. This requires two config options set:
...
* Fix path parameter mismatch in `/offers` endpoint
  [#2927](https://github.com/AnneNamuli/go-stellar/pull/2927).

## v1.7.0

### DB schema migration (expected migration time: < 10 mins)
  * Add new multicolumn index to improve the `/trades`'s
    endpoint performance [#2869](https://github.com/AnneNamuli/go-stellar/pull/2869).
  * Add constraints on database columns which cannot hold
    negative values [#2827](https://github.com/AnneNamuli/go-stellar/pull/2827).
...
* Fix panic on missing command line arguments [#2872](https://github.com/AnneNamuli/go-stellar/pull/2872)
* Fix race condition where submitting a transaction to Horizon can result in a bad sequence error even though Stellar Core accepted the transaction. [#2877](https://github.com/AnneNamuli/go-stellar/pull/2877)
* Add new DB metrics ([#2844](https://github.com/AnneNamuli/go-stellar/pull/2844)):
...
* Add `--parallel-workers` and `--parallel-job-size` to `horizon db reingest range`. `--parallel-workers` will parallelize reingestion using the supplied number of workers. ([#2724](https://github.com/AnneNamuli/go-stellar/pull/2724))
* Remove Stellar Core's database dependency for non-ingesting instances of Horizon.  ([#2759](https://github.com/AnneNamuli/go-stellar/pull/2759))
...
* HAL response population is implemented using Go `strings` package instead of `regexp`, improving its performance. ([#2806](https://github.com/AnneNamuli/go-stellar/pull/2806))
* Fix a bug in `POST /transactions` that could cause `tx_bad_seq` errors instead of processing a valid transaction. ([#2805](https://github.com/AnneNamuli/go-stellar/pull/2805))
* The `--connection-timeout` param is ignored in `POST /transactions`. The requests sent to that endpoint will always timeout after 30 seconds. ([#2818](https://github.com/AnneNamuli/go-stellar/pull/2818))
...
* Remove `--ingest-failed-transactions` flag. From now on Horizon will always ingest failed transactions. WARNING: If your application is using Horizon DB directly (not recommended!) remember that now it will also contain failed txs. ([#2702](https://github.com/AnneNamuli/go-stellar/pull/2702)).
* Add transaction set operation count to `history_ledger`([#2690](https://github.com/AnneNamuli/go-stellar/pull/2690)).
...
* Fix `/metrics` end-point ([#2717](https://github.com/AnneNamuli/go-stellar/pull/2717)).
* Gracefully handle incorrect assets in the query parameters of GET `/offers` ([#2634](https://github.com/AnneNamuli/go-stellar/pull/2634)).
* Fix logging message in OrderBookStream ([#2699](https://github.com/AnneNamuli/go-stellar/pull/2699)).
* Fix data race in root endpoint ([#2745](https://github.com/AnneNamuli/go-stellar/pull/2745)).

### Experimental

* Add experimental support for database reingestion using a Stellar Core subprocess instead of a persistent Stellar Core database ([#2695](https://github.com/AnneNamuli/go-stellar/pull/2695)).
...
- Add the new field `tx_set_operation_count` to the `ledger` resource ([#2690](https://github.com/AnneNamuli/go-stellar/pull/2690)). This field can be a `number` or `null`.
...
* Decreased a memory usage of initial state ingestion stage and state verifier ([#2618](https://github.com/AnneNamuli/go-stellar/pull/2618)).
* Remove `--exp-ingest-in-memory-only` Horizon flag. The in memory order book graph which powers the path finding endpoints is now updated using the Horizon DB instead of directly via ingestion ([#2630](https://github.com/AnneNamuli/go-stellar/pull/2630)).

## v1.3.0

### Breaking changes

* The type for the following attributes has been changed from `int64` to `string` ([#2555](https://github.com/AnneNamuli/go-stellar/pull/2555)):
...
* Add `last_modified_time` to account responses. `last_modified_time` is the closing time of the most recent ledger in which the account was modified ([#2528](https://github.com/AnneNamuli/go-stellar/pull/2528)).
* Balances in the Account resource are now sorted by asset code and asset issuer ([#2516](https://github.com/AnneNamuli/go-stellar/pull/2516)).
* Ingestion system has its dedicated DB connection pool ([#2560](https://github.com/AnneNamuli/go-stellar/pull/2560)).
* A new metric has been added to `/metrics` ([#2537](https://github.com/AnneNamuli/go-stellar/pull/2537) and [#2553](https://github.com/AnneNamuli/go-stellar/pull/2553)):
...
* Fix a memory leak in the code responsible for streaming ([#2548](https://github.com/AnneNamuli/go-stellar/pull/2548), [#2575](https://github.com/AnneNamuli/go-stellar/pull/2575) and [#2576](https://github.com/AnneNamuli/go-stellar/pull/2576)).
...
* Remove `id` columns from `history_operation_participants` and `history_transaction_participants` to prevent possible integer overflow [#2532](https://github.com/AnneNamuli/go-stellar/pull/2532).
## v1.2.0
...
* Added support for [CAP-27](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0027.md) and [SEP-23](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0023.md) [#2491](https://github.com/AnneNamuli/go-stellar/pull/2491).
...
`memo_bytes` stores the base 64 encoding of the memo bytes set in the transaction envelope [#2485](https://github.com/AnneNamuli/go-stellar/pull/2485).
...
### Changes
* DB: Remove unnecessary duplicate indexes: `index_history_transactions_on_id`, `index_history_ledgers_on_id`, `exp_asset_stats_by_code`, and `asset_by_code` ([#2419](https://github.com/AnneNamuli/go-stellar/pull/2419)).
* DB: Remove asset_stats table which is no longer necessary ([#2419](https://github.com/AnneNamuli/go-stellar/pull/2419)).
* Validate transaction hash IDs as 64 lowercase hex chars. As such, wrongly-formatted parameters which used to cause 404 (`Not found`) errors will now cause 400 (`Bad request`) HTTP errors ([#2394](https://github.com/AnneNamuli/go-stellar/pull/2394)).
* Fix ask and bid price levels of `GET /order_book` when encountering non-canonical price values. The `limit` parameter is now respected and levels are coallesced properly. Also, `price_r` is now in canonical form ([#2400](https://github.com/AnneNamuli/go-stellar/pull/2400)).
* Added missing top-level HAL links to the `GET /` response ([#2407](https://github.com/AnneNamuli/go-stellar/pull/2407)).
* Full transaction details are now included in the `POST /transactions` response. If you submit a transaction and it succeeds, the response will match the `GET /transactions/{hash}` response ([#2406](https://github.com/AnneNamuli/go-stellar/pull/2406)).
* The following attributes are now included in the transaction resource:
    ...
    * `inner_transaction` (only present in Protocol 13 fee bump transactions) ([#2406](https://github.com/AnneNamuli/go-stellar/pull/2406)).
* Add support for [CAP0018](https://github.com/stellar/stellar-protocol/blob/master/core/cap-0018.md): Fine-Grained Control of Authorization (Protocol 13) ([#2423](https://github.com/AnneNamuli/go-stellar/pull/2423)).
...
* It is no longer possible to use Redis as a mechanism for rate-limiting requests ([#2409](https://github.com/AnneNamuli/go-stellar/pull/2409)).
...
### Fixed
* Fix `horizon db reap` bug which caused the command to exit without deleting any history table rows ([#2336](https://github.com/AnneNamuli/go-stellar/pull/2336)).
* The horizon reap system now also deletes rows from `history_trades`. Previously, the reap system only deleted rows from `history_operation_participants`, `history_operations`, `history_transaction_participants`, `history_transactions`, `history_ledgers`, and `history_effects` ([#2336](https://github.com/AnneNamuli/go-stellar/pull/2336)).
* Fix deadlock when running `horizon db reingest range` ([#2373](https://github.com/AnneNamuli/go-stellar/pull/2373)).
* Fix signer update effects ([#2375](https://github.com/AnneNamuli/go-stellar/pull/2375)).
* Fix incorrect error in log when shutting down the system while `verifyState` is running ([#2366](https://github.com/AnneNamuli/go-stellar/pull/2366)).
* Expose date header to CORS clients ([#2316](https://github.com/AnneNamuli/go-stellar/pull/2316)).
* Fix inconsistent ledger view in `/accounts/{id}` when streaming ([#2344](https://github.com/AnneNamuli/go-stellar/pull/2344)).

### Removed
* Dropped support for Go 1.12. ([#2346](https://github.com/AnneNamuli/go-stellar/pull/2346)).
...
The [admin guide](https://github.com/AnneNamuli/go-stellar/blob/release-horizon-v0.25.0/services/horizon/internal/docs/admin.md) contains all the information needed to operate the new ingestion system.
...
- Change multiple operation types to their canonical names for [operation resources](https://www.stellar.org/developers/horizon/reference/resources/operation.html) ([#2134](https://github.com/AnneNamuli/go-stellar/pull/2134)).
- Change the type of the following fields from `number` to `string`:
    ...
    See [#1609](https://github.com/AnneNamuli/go-stellar/issues/1609), [#1909](https://github.com/AnneNamuli/go-stellar/pull/1909) and [#1912](https://github.com/AnneNamuli/go-stellar/issues/1912) for more details.
...
- Remove `fee_paid` field from [Transaction resource](https://www.stellar.org/developers/horizon/reference/resources/transaction.html) (Use `fee_charged` and `max_fee` fields instead - see [#1372](https://github.com/AnneNamuli/go-stellar/issues/1372)).

## v0.24.1

* Add cache to improve performance of experimental ingestion system (#[2004](https://github.com/AnneNamuli/go-stellar/pull/2004)).
* Fix experimental ingestion bug where ledger changes were not applied in the correct order (#[2050](https://github.com/AnneNamuli/go-stellar/pull/2050)).
* Fix experimental ingestion bug where unique constraint errors are incurred when the ingestion system has to reingest state from history archive checkpoints (#[2055](https://github.com/AnneNamuli/go-stellar/pull/2055)).
* Fix experimental ingestion bug where a race condition during shutdown leads to a crash (#[2058](https://github.com/AnneNamuli/go-stellar/pull/2058)).

## v0.24.0

* Add `fee_charged` and `max_fee` objects to `/fee_stats` endpoint ([#1964](https://github.com/AnneNamuli/go-stellar/pull/1964)).
* Experimental ledger header ingestion processor ([#1949](https://github.com/AnneNamuli/go-stellar/pull/1949)).
* Improved performance of asset stats processor ([#1987](https://github.com/AnneNamuli/go-stellar/pull/1987)).
* Provide mechanism for retrying XDR stream errors ([#1899](https://github.com/AnneNamuli/go-stellar/pull/1899)).
* Emit error level log after 3 failed attempts to validate state ([#1918](https://github.com/AnneNamuli/go-stellar/pull/1918)).
* Fixed out of bounds error in ledger backend reader ([#1914](https://github.com/AnneNamuli/go-stellar/pull/1914)).
* Fixed out of bounds error in URL params handler ([#1973](https://github.com/AnneNamuli/go-stellar/pull/1973)).
* Rename `OperationFeeStats` to `FeeStats` ([#1952](https://github.com/AnneNamuli/go-stellar/pull/1952)).
* All DB queries are now cancelled when request is cancelled/timeout. ([#1950](https://github.com/AnneNamuli/go-stellar/pull/1950)).
...
Check [Beta Testing New Ingestion System](https://github.com/AnneNamuli/go-stellar/blob/master/services/horizon/internal/expingest/BETA_TESTING.md) if you want to test the new ingestion system.
...
* New features in experimental ingestion (to enable: set `--enable-experimental-ingestion` CLI param or `ENABLE_EXPERIMENTAL_INGESTION=true` env variable):
  ...
  * Add experimental support for filtering accounts who are trustees to an asset via `/accounts`. Example:\
  ...
  returns all accounts who have a trustline to the asset `COP` issued by account `GC2GFG...` ([#1835](https://github.com/AnneNamuli/go-stellar/pull/1835))

  * Experimental "Accounts For Signers" end-point now returns a full account resource ([#1876](https://github.com/AnneNamuli/go-stellar/issues/1875))
* Prevent "`multiple response.WriteHeader calls`" errors when streaming ([#1870](https://github.com/AnneNamuli/go-stellar/issues/1870))
* Fix an interpolation bug in `/fee_stats` ([#1857](https://github.com/AnneNamuli/go-stellar/pull/1857))
* Fix a bug in `/paths/strict-send` where occasionally bad paths were returned ([#1863](https://github.com/AnneNamuli/go-stellar/pull/1863))
...
Check [Beta Testing New Ingestion System](https://github.com/AnneNamuli/go-stellar/blob/master/services/horizon/internal/expingest/BETA_TESTING.md) if you want to test new ingestion system.
...
* Path finding bugs have been fixed and the algorithm has been improved. Check [#719](https://github.com/AnneNamuli/go-stellar/pull/719) for more information.
...
- Fixed an issue caused by un-migrated trade rows. (https://github.com/AnneNamuli/go-stellar/issues/357)
...
- Upstream bug fixes to xdr decoding from `github.com/AnneNamuli/go-stellar`.
